...
//	}
	...
	public void getProfilepage() throws InterruptedException {
		Thread.sleep(5000);
		ElementClick(profile);
		ElementClick(viewupdate);
	...
	public void getExperience() throws InterruptedException, IOException {
	...
	public void getSalarybreak() throws InterruptedException {
		Thread.sleep(3000);
		ElementClick(salarybreak);
		Thread.sleep(3000);
		ElementClick(fixed);
	...
	public void getNoticePeriod() throws InterruptedException {
		Thread.sleep(3000);
		ElementClick(availablity);
